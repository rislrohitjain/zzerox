...
<body>
    <div class="maintenance-card">
        <img src="{{ asset('img/logo.png') }}" alt="Zerox" style="height: 50px; margin-bottom: 2rem;">
        ...
        <div class="p-3 bg-dark bg-opacity-50 rounded border border-secondary text-muted small">
            For urgent distribution or verification inquiries, please contact: <strong class="text-light">support@zzerox.com</strong>
        </div>
        <div class="mt-4 pt-2">
