    ...
    <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            <div class="col-md-4">
                ...
                <input type="text" id="categoryNameInput" name="name" class="form-control" value="{{ old('name', $category->name) }}" required>
            </div>
            ...
            <div class="col-md-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="categorySlugInput" name="slug" class="form-control font-monospace" value="{{ old('slug', $category->slug) }}" required>
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <textarea id="editor-cat-description" name="description" class="form-control">{!! old('description', $category->description) !!}</textarea>
            </div>
